<template>
  <div class="container-fluid pink-gradient">
    <div class="row text-center mt-5 animate__animated animate__fadeInDown">
    ...
    <div v-if="user.isAuthenticated" class="row text-center animate__animated animate__fadeInDown">
      <div class="col-6">
...
.pink-gradient{
 background: #EF3B36;
background: -webkit-linear-gradient(to bottom, #FFFFFF, #EF3B36);
background: linear-gradient(to bottom, #FFFFFF, #EF3B36);
...
border-radius: 100px;
background: #F7E7CE;
box-shadow: 0px 0px 12px 2px #dacbb5;
bottom: 0;
opacity: 0;
